...
annotation(figure1,'textarrow',[0.764285714285714 0.72202380952381],...
    ...
    'String',{'x2'});
% Save figure
saveas(gcf,'./figs//Fig-1b.eps','epsc2')
set(gcf,'PaperPositionMode','Auto') 
saveas(gcf,'./figs//Fig-1b_nonquadr.eps','epsc2')
saveas(gcf,'./figs//IntegratedLinePlotOfAbsFTg_(Fig-1b).eps','epsc2')
...
%     'String',{'x2'});
% % Save figure
% saveas(gcf,'./figs//Fig-1c.eps','epsc2')
% set(gcf,'PaperPositionMode','Auto') 
% saveas(gcf,'./figs//Fig-1c_nonquadr.eps','epsc2')
% saveas(gcf,'./figs//IntegratedLinePlotOfAbsFTg_(Fig-1b).eps','epsc2')
